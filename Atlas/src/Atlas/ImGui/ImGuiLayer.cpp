...
namespace Atlas
{
	...
	bool ImGuiLayer::OnKeyPressedEvent(KeyPressedEvent& e)
	{
		...
		io.KeyCtrl = io.KeysDown[Key::LEFT_CONTROL] || io.KeysDown[Key::RIGHT_CONTROL];
		io.KeyShift = io.KeysDown[Key::LEFT_SHIFT] || io.KeysDown[Key::RIGHT_SHIFT];
		io.KeyAlt = io.KeysDown[Key::LEFT_ALT] || io.KeysDown[Key::RIGHT_ALT];
		io.KeySuper = io.KeysDown[Key::LEFT_SUPER] || io.KeysDown[Key::RIGHT_SUPER];
